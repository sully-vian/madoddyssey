...
export function handlePlatformCollisions(player: Player, platform: Platform) {
...
export function handlePlayerEnemyCollisions(player: Player, enemy: Enemy) {
    // handle collision (call only if collision detected)
...
function playerLandsOnEnemy(player: Player, enemy: Enemy) {
    if (!enemy.dead) {
        enemy.die();
    }
...
function playerHitsEnemy(player: Player, enemy: Enemy) {
    if (enemy.dead) {
